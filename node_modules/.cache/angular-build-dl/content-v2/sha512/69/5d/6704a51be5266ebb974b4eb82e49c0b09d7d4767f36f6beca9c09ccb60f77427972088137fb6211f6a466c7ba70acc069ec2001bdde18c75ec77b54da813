(function () {
  ...
  (self["webpackChunkangular_calendar"] = self["webpackChunkangular_calendar"] || []).push([["projects_demos_app_demo-modules_show-dates-on-titles_module_ts"], {
    ...
    /***/
    66143: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */
      ...
      var _custom_event_title_formatter_provider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./custom-event-title-formatter.provider */
      30711);
      /* harmony import */
      ...
      _DemoComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 12,
        vars: 6,
        consts: [[3, "view", "viewDate", "viewChange", "viewDateChange"], [3, "ngSwitch"], [3, "viewDate", "events", "activeDayIsOpen", 4, "ngSwitchCase"], [3, "viewDate", "events", 4, "ngSwitchCase"], [3, "viewDate", "events", "activeDayIsOpen"], [3, "viewDate", "events"]],
    ...
    /***/
    30711: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */
      ...
      var _CustomEventTitleFormatter = /*#__PURE__*/function (_angular_calendar__WE) {
        ...
        function _CustomEventTitleFormatter(locale) {
          var _this;
        ...
        _createClass(_CustomEventTitleFormatter, [{
          key: "month",
          value: function month(event) {
            return "<b>".concat((0, _angular_common__WEBPACK_IMPORTED_MODULE_1__.formatDate)(event.start, 'h:m a', this.locale), "</b> ").concat(event.title);
          }
        }, {
          key: "week",
      ...
      }(angular_calendar__WEBPACK_IMPORTED_MODULE_0__.CalendarEventTitleFormatter);

      _CustomEventTitleFormatter.ɵfac = function CustomEventTitleFormatter_Factory(t) {
        return new (t || _CustomEventTitleFormatter)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_2__.LOCALE_ID));
      };

      _CustomEventTitleFormatter.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
    ...
    /***/
    15188: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */
...
//# sourceMappingURL=projects_demos_app_demo-modules_show-dates-on-titles_module_ts-es5.js.map