    ...
    98345: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function DemoComponent_mwl_calendar_month_view_12_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("columnHeaderClicked", function DemoComponent_mwl_calendar_month_view_12_Template_mwl_calendar_month_view_columnHeaderClicked_0_listener($event) {
      ...
      function DemoComponent_mwl_calendar_week_view_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("dayHeaderClicked", function DemoComponent_mwl_calendar_week_view_14_Template_mwl_calendar_week_view_dayHeaderClicked_0_listener($event) {
      ...
      function DemoComponent_mwl_calendar_day_view_16_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("hourSegmentClicked", function DemoComponent_mwl_calendar_day_view_16_Template_mwl_calendar_day_view_hourSegmentClicked_0_listener($event) {
