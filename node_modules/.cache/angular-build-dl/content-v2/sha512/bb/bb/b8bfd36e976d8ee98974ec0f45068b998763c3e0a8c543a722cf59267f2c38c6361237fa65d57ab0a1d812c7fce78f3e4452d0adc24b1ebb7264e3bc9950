(function () {
  ...
  (self["webpackChunkangular_calendar"] = self["webpackChunkangular_calendar"] || []).push([["projects_demos_app_demo-modules_custom-templates_module_ts"], {
    /***/
    69151: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_calendar_src_modules_common_calendar_date_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../../angular-calendar/src/modules/common/calendar-date.pipe */
      12153);

      function DemoComponent_ng_template_9_span_3_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var day_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().day;
      ...
      function DemoComponent_mwl_calendar_month_view_14_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DemoComponent_mwl_calendar_week_view_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DemoComponent_mwl_calendar_day_view_18_Template(rf, ctx) {
        if (rf & 1) {
      ...
      _DemoComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 21,
        vars: 6,
        consts: [[3, "view", "viewDate", "viewChange", "viewDateChange"], [1, "alert", "alert-info"], ["href", "https://github.com/mattlewis92/angular-calendar#how-do-i-use-a-custom-template"], ["customCellTemplate", ""], [3, "ngSwitch"], [3, "viewDate", "events", "cellTemplate", 4, "ngSwitchCase"], [3, "viewDate", "events", 4, "ngSwitchCase"], [1, "cal-cell-top"], ["class", "cal-day-badge", 4, "ngIf"], [1, "cal-day-number"], [2, "margin", "5px"], [1, "cal-day-badge"], [3, "viewDate", "events", "cellTemplate"], [3, "viewDate", "events"]],
        ...
        pipes: [_angular_calendar_src_modules_common_calendar_date_pipe__WEBPACK_IMPORTED_MODULE_7__.CalendarDatePipe],
        encapsulation: 2,
        changeDetection: 0
      });
      /***/
    ...
    /***/
    18243: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */
...
//# sourceMappingURL=projects_demos_app_demo-modules_custom-templates_module_ts-es5.js.map