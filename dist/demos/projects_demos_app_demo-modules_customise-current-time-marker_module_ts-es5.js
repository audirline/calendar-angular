(function () {
  ...
  (self["webpackChunkangular_calendar"] = self["webpackChunkangular_calendar"] || []).push([["projects_demos_app_demo-modules_customise-current-time-marker_module_ts"], {
    /***/
    45622: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_calendar_src_modules_week_calendar_week_view_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      function DemoComponent_ng_template_0_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div", 6);
        }

        if (rf & 2) {
          var topPx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().topPx;

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstyleProp"]("top", topPx_r8, "px");
        }
      }

      function DemoComponent_ng_template_0_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var isVisible_r7 = ctx.isVisible;
      ...
      var _DemoComponent = function _DemoComponent() {
        ...
        this.showMarker = true; // just for the purposes of the demo so it all fits in one screen
      ...
      _DemoComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 14,
        vars: 5,
        consts: [["currentTimeMarkerTemplate", ""], [1, "form-group", "form-check"], ["type", "checkbox", "id", "showMarker", 1, "form-check-input", 3, "ngModel", "ngModelChange"], ["for", "showMarker", 1, "form-check-label"], [3, "viewDate", "currentTimeMarkerTemplate", "dayStartHour", "dayEndHour"], ["class", "cal-current-time-marker", 3, "top", 4, "ngIf"], [1, "cal-current-time-marker"]],
        template: function DemoComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DemoComponent_Template_input_ngModelChange_5_listener($event) {
              return ctx.showMarker = $event;
            });
    ...
    /***/
    50641: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */
...
//# sourceMappingURL=projects_demos_app_demo-modules_customise-current-time-marker_module_ts-es5.js.map